...
namespace HexaOnlineOrdering.Repositories.Migrations
{
    ...
    [Migration("20221202042234_Update_TblCasePresentaionHistory")]
    partial class Update_TblCasePresentaionHistory
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("HexaOnlineOrdering.Repositories.DataModels.TblCaseAttachedFile", b =>
                {
                    ...
                    b.Property<int?>("CasePresentationHistoryId")
                        .HasColumnType("int");
                    ...
                    b.Property<DateTime>("UploadedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime(6)")
                        .HasDefaultValue(new DateTime(2022, 12, 2, 11, 22, 32, 341, DateTimeKind.Local).AddTicks(7270))
                    ...
                    b.HasIndex("CasePresentationHistoryId");
            ...
            modelBuilder.Entity("HexaOnlineOrdering.Repositories.DataModels.TblCasePresentationHistory", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<DateTime>("RequestEditDate")
                        .HasColumnType("datetime(6)");
                    ...
                    b.ToTable("TblCasePresentationHistory");
                });
            ...
            modelBuilder.Entity("HexaOnlineOrdering.Repositories.DataModels.TblCaseProduct", b =>
                {
                    ...
                    b.Property<string>("SubstitutionTooth")
                        .HasMaxLength(200)
                        .HasColumnType("varchar(200)");
            ...
            modelBuilder.Entity("HexaOnlineOrdering.Repositories.DataModels.TblRejectNote", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("HexaOnlineOrdering.Repositories.DataModels.TblUser", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Active = true,
                            ContactId = 32503,
                            CreateAt = new DateTime(2022, 12, 2, 11, 22, 32, 348, DateTimeKind.Local).AddTicks(3369),
                            LastUpdate = new DateTime(2022, 12, 2, 11, 22, 32, 348, DateTimeKind.Local).AddTicks(3413),
                        ...
                        new
                        {
                            ...
                            Active = true,
                            ContactId = 21379,
                            CreateAt = new DateTime(2022, 12, 2, 11, 22, 32, 348, DateTimeKind.Local).AddTicks(9975),
                            LastUpdate = new DateTime(2022, 12, 2, 11, 22, 32, 348, DateTimeKind.Local).AddTicks(9990),
                        ...
                        new
                        {
                            UserId = 3,
                            Active = true,
                            CreateAt = new DateTime(2022, 12, 2, 11, 22, 32, 348, DateTimeKind.Local).AddTicks(9997),
                            LastUpdate = new DateTime(2022, 12, 2, 11, 22, 32, 348, DateTimeKind.Local).AddTicks(9999),
                            Name = "System Admin",
                            Password = "admin",
                            UserRoleId = 3,
                            Username = "Admin"
                        ...
                        new
                        {
                            UserId = 4,
                            Active = true,
                            CreateAt = new DateTime(2022, 12, 2, 11, 22, 32, 349, DateTimeKind.Local).AddTicks(1),
                            LastUpdate = new DateTime(2022, 12, 2, 11, 22, 32, 349, DateTimeKind.Local).AddTicks(3),
                            Name = "Leknoi",
                            Password = "staff",
                            UserRoleId = 4,
                            Username = "Staff"
            ...
            modelBuilder.Entity("TblProductTypeTblUserRole", b =>
                {
                    ...
                    b.HasKey("ProductTypeId", "UserRoleId");
            ...
            modelBuilder.Entity("HexaOnlineOrdering.Repositories.DataModels.TblCaseAttachedFile", b =>
                {
                    ...
                    b.HasOne("HexaOnlineOrdering.Repositories.DataModels.TblCasePresentationHistory", "CasePresentationHistory")
                        .WithMany("RequestCaseAttachedFiles")
                        .HasForeignKey("CasePresentationHistoryId");
                    ...
                    b.Navigation("CasePresentationHistory");
                });
            ...
            modelBuilder.Entity("HexaOnlineOrdering.Repositories.DataModels.TblRejectNote", b =>
                {
                    b.HasOne("HexaOnlineOrdering.Repositories.DataModels.TblCase", "Case")
                        .WithOne("RejectNote")
                        .HasForeignKey("HexaOnlineOrdering.Repositories.DataModels.TblRejectNote", "CaseId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("HexaOnlineOrdering.Repositories.DataModels.TblUser", "RejectUser")
                        .WithMany()
            ...
            modelBuilder.Entity("HexaOnlineOrdering.Repositories.DataModels.TblCasePresentationHistory", b =>
                {
                    b.Navigation("RequestCaseAttachedFiles");
                });
