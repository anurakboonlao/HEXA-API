...
namespace HexaOnlineOrdering.Repositories.Migrations
{
    ...
    [Migration("20230904084545_Seed_Catalog2023")]
    partial class Seed_Catalog2023
    {
            ...
            modelBuilder.Entity("HexaOnlineOrdering.Repositories.DataModels.TblCaseAttachedFile", b =>
                {
                    ...
                    b.Property<DateTime>("UploadedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime(6)")
                        .HasDefaultValue(new DateTime(2023, 9, 4, 15, 45, 44, 150, DateTimeKind.Local).AddTicks(6829))
            ...
            modelBuilder.Entity("HexaOnlineOrdering.Repositories.DataModels.TblUser", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Active = true,
                            ContactId = 32503,
                            CreateAt = new DateTime(2023, 9, 4, 15, 45, 44, 153, DateTimeKind.Local).AddTicks(5935),
                            LastUpdate = new DateTime(2023, 9, 4, 15, 45, 44, 153, DateTimeKind.Local).AddTicks(5954),
                        ...
                        new
                        {
                            ...
                            Active = true,
                            ContactId = 21379,
                            CreateAt = new DateTime(2023, 9, 4, 15, 45, 44, 153, DateTimeKind.Local).AddTicks(7107),
                            LastUpdate = new DateTime(2023, 9, 4, 15, 45, 44, 153, DateTimeKind.Local).AddTicks(7112),
                        ...
                        new
                        {
                            UserId = 3,
                            Active = true,
                            CreateAt = new DateTime(2023, 9, 4, 15, 45, 44, 153, DateTimeKind.Local).AddTicks(7115),
                            LastUpdate = new DateTime(2023, 9, 4, 15, 45, 44, 153, DateTimeKind.Local).AddTicks(7115),
                            Name = "System Admin",
                            Password = "admin",
                            UserRoleId = 3,
                            Username = "Admin"
                        ...
                        new
                        {
                            UserId = 4,
                            Active = true,
                            CreateAt = new DateTime(2023, 9, 4, 15, 45, 44, 153, DateTimeKind.Local).AddTicks(7117),
                            LastUpdate = new DateTime(2023, 9, 4, 15, 45, 44, 153, DateTimeKind.Local).AddTicks(7118),
                            Name = "Leknoi",
                            Password = "staff",
                            UserRoleId = 4,
                            Username = "Staff"
            ...
            modelBuilder.Entity("HexaOnlineOrdering.Repositories.DataModels.TblRejectNote", b =>
                {
                    b.HasOne("HexaOnlineOrdering.Repositories.DataModels.TblOrder", "Order")
                        .WithOne("RejectNote")
                        .HasForeignKey("HexaOnlineOrdering.Repositories.DataModels.TblRejectNote", "OrderId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
